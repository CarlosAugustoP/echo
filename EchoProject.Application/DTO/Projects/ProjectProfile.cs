    ...
    public class ProjectProfile : Profile
    {
        public ProjectProfile()
        {
            ...
            CreateMap<Project, ProjectDTO>()
                ...
                .ForMember(dest => dest.Goals, opt => opt.MapFrom(src => PrepareGoals(src.ActiveGoals)))
        ...
        private static List<Goal> PrepareGoals(IEnumerable<Goal> list)
        {
            return list
                .OrderBy(x => x.IsAchieved)
                .ThenBy(x => x.IsMoney()).ToList();
        }
    }
}
