...
{
    [AutoMap(typeof(User))]
    public class UserDTO(Guid id, string name, string email, string walletAddress, TaxId taxId, UserRole role, bool isFirstAccess = true, DateTime? verifiedAt = null, string? bio = null, ImageUrl? profilePicture = null)
    {
        ...
        public bool IsFirstAccess { get; set; } = isFirstAccess;
